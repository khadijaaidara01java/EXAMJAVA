...
if(isset($_POST['inscription_joueur'])) {
    $nom = $_POST['nom'];
    $email = $_POST['email'];
    ...
    $requete = $connexion->prepare("INSERT INTO users (nom, email, passwords) VALUES (?, ?, ?)");
...
<div class="container">
    <div class="form_area">
        <p class="title">Inscription Joueur</p>
        <form action="inscription_joueur.php" method="post">
            ...
            <div>
            <button class="btn" name="inscription_joueur">S'inscrire</button>
